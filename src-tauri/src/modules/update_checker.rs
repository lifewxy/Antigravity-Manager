...
mod tests {
    ...
    fn test_compare_versions() {
        assert!(compare_versions("3.3.31", "3.3.30"));
        assert!(compare_versions("3.4.0", "3.3.30"));
        assert!(compare_versions("4.0.0", "3.3.30"));
        assert!(!compare_versions("3.3.29", "3.3.30"));
        assert!(!compare_versions("3.3.30", "3.3.30"));
    }
